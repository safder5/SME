...
import 'package:ashwani/src/Screens/newOrders/addItemto%20Order/add_purchase_order_item.dart';
...
class _NewPurchaseOrderState extends State<NewPurchaseOrder> {
  ...
  _showMyDialog(BuildContext context, String text) {
    return showDialog(
        context: context,
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<VendorProvider>(builder: (_, vn, __) {
      vendorNames = vn.getAllVendorNames();
      suggestions = vendorNames;
      return Scaffold(
        ...
        bottomNavigationBar: Padding(
          ...
          child: GestureDetector(
            onTap: () async {
              ...
              } else if (poItemsProvider.poItems.isEmpty) {
                _showMyDialog(context, 'Avoid empty Orders');
              } else if (_vendorName.text.isEmpty) {
                _showMyDialog(context, 'Select a Vendor or Create one');
              } else {
                _showMyDialog(context, 'Could not create Purchase Order');
              }
